                ...
                >
                  ...
                  <Image
                    ...
                    className={cn(
                      ...
                      loadedImages.has(`offer-${offer.id}`) ? "opacity-100" : "opacity-0"
                    )}
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 pt-10 text-white sm:p-8 sm:pt-16 lg:pt-24" dir={locale === "ar" ? "rtl" : "ltr"}>
                    <div className="max-w-[44rem] space-y-4 pt-5 transition-transform duration-200 ease-out group-hover:-translate-y-0.5 sm:space-y-6 sm:pt-8 lg:pt-10">
                ...
                <CardContent className="flex flex-1 flex-col gap-4 border-t bg-gradient-to-b from-card to-muted/25 p-4 transition-colors duration-200 group-hover:from-card group-hover:to-accent/8 sm:p-6">
                  ...
                  <div className="mt-auto pt-2">
                    {quantity > 0 ? (
                      ...
                      <Button
                        type="button"
                        className="h-12 w-full gap-2 rounded-lg border border-[#21100a]/10 bg-[#21100a] px-4 text-sm font-bold text-primary-foreground shadow-[0_8px_18px_rgba(33,16,10,0.12)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#21100a]/90 hover:text-primary-foreground hover:shadow-[0_12px_24px_rgba(33,16,10,0.18)] active:translate-y-0 active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 dark:border-[hsl(30_33%_84%)]/35 dark:bg-[hsl(30_33%_84%)] dark:text-[#21100a] dark:hover:bg-[hsl(30_33%_84%)] dark:hover:text-[#21100a] dark:hover:shadow-[0_10px_22px_rgba(228,214,201,0.14)]"
                        onClick={(event) => {
